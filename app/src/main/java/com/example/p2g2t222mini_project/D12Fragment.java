    ...
    private void onRollDice(){
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if(mainActivity.diceColorRed == true) {
                    Drawable diceImage = (Drawable) getResources().getDrawable(R.drawable.d12_red1);
                    int nextID = globalList.getNextID();
                    int sortingid = globalList.getNextID();
                    RollHistoryItem item = new RollHistoryItem(nextID, "D12", number, diceImage, sortingid);
                    rollHistoryList.add(item);
                    globalList.setNextID(nextID+1);
                }
                if(mainActivity.diceColorGreen == true) {
                    Drawable diceImage = (Drawable) getResources().getDrawable(R.drawable.d12_green1);
                    int nextID = globalList.getNextID();
                    int sortingid = globalList.getNextID();
                    RollHistoryItem item = new RollHistoryItem(nextID, "D12", number, diceImage, sortingid);
                    rollHistoryList.add(item);
                ...
                if(mainActivity.diceColorBlue == true) {
                    Drawable diceImage = (Drawable) getResources().getDrawable(R.drawable.d12_blue1);
                    int nextID = globalList.getNextID();
                    int sortingid = globalList.getNextID();
                    RollHistoryItem item = new RollHistoryItem(nextID, "D12", number, diceImage, sortingid);
                    rollHistoryList.add(item);
